  ...
  return (
    <motion.article
      ...
      className={cn(
        ...
        "overflow-hidden active:scale-[0.98] transition-transform duration-150",
      )}
      onClick={onOpen}
      onKeyDown={(e) => {
    ...
    >
      <div className="grid h-full grid-cols-1 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)]">
        {/* Left: text & stats */}
        <div className="relative px-5 py-7 sm:px-8 sm:py-10 md:px-10 md:py-12">
          {/* Big faint number */}
...
export function SpecialtiesShowcase() {
  ...
  return (
    <main className="bg-[#f7f3ee] text-slate-900">
      ...
      {activeProgram && (
        <div
          className="fixed inset-0 z-50 bg-black/70 backdrop-blur-sm overflow-y-auto overscroll-contain p-4 md:p-8"
        ...
        >
          <div className="flex min-h-full items-start justify-center sm:items-center">
            <div
              className="relative w-full max-w-2xl rounded-3xl bg-white shadow-2xl border border-slate-200 overflow-hidden my-4"
            ...
            >
              ...
              <button
                type="button"
                onClick={() => setActiveProgram(null)}
                className="absolute right-3 top-3 z-20 flex size-9 items-center justify-center rounded-full bg-black/40 text-white hover:bg-black/60 focus-visible:ring-2 ring-white ring-offset-2 ring-offset-transparent cursor-pointer"
              ...
              <div className="relative h-36 sm:h-40 w-full bg-slate-900 shrink-0">
              <div
